...
const product = {"repo":"InvoiceKit","suite":"Professional Utility","category":"Invoice operations","audience":"freelancers, agencies, trades, and small businesses","promise":"create invoices that look premium, track risk, and get paid faster","inputLabel":"Client, work, amount, and payment terms","placeholder":"Client: Green Cafe. Website refresh. $2,400. Due in 7 days.","primary":"Build invoice","gradient":"from-green-300 via-emerald-200 to-teal-300","metrics":["Payment-ready","Tax-aware","Follow-up plan"],"modules":["Invoice builder","Late-payment risk","Payment terms advisor","Reminder schedule","Client ledger"],"outputs":["Invoice summary","Payment terms","Follow-up email","Risk warning"],"pricing":"Free 3 invoices, $12/month Solo, $49/month Studio."} as const;
